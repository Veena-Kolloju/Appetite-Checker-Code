...
namespace MyWebApi.Migrations
{
    ...
    [Migration("20251024101127_RemoveOrganizationIdFromUsers")]
    partial class RemoveOrganizationIdFromUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWebApi.Models.DbProduct", b =>
                {
                    ...
                    b.HasIndex("CarrierID")
                        .HasDatabaseName("IDX_Products_CarrierID");

                    b.HasIndex("ProductTypeId")
                        .HasDatabaseName("IDX_Products_ProductTypeId");

                    b.ToTable("Products");
                });

            modelBuilder.Entity("MyWebApi.Models.DbProductType", b =>
                {
                    b.Property<int>("ProductTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("IDX_ProductTypes_IsActive");

                    b.HasIndex("TypeName")
                        .IsUnique()
                        .HasDatabaseName("IDX_ProductTypes_TypeName");

                    b.ToTable("ProductTypes");
                });

            modelBuilder.Entity("MyWebApi.Models.DbRole", b =>
                {
                    ...
                    b.HasIndex("RoleName")
                        .IsUnique()
                        .HasDatabaseName("IDX_Roles_RoleName");
            ...
            modelBuilder.Entity("MyWebApi.Models.DbRule", b =>
                {
                    ...
                    b.Property<int?>("PriorClaimsThreshold")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CarrierID")
                        .HasDatabaseName("IDX_Rules_CarrierID");

                    b.HasIndex("NaicsCodes")
                        .HasDatabaseName("IDX_Rules_Naics");

                    b.HasIndex("ProductID")
                        .HasDatabaseName("IDX_Rules_ProductID");
            ...
            modelBuilder.Entity("MyWebApi.Models.DbUser", b =>
                {
                    ...
                    b.HasIndex("CarrierID")
                        .HasDatabaseName("IDX_Users_CarrierID");
                    ...
                    b.HasIndex("RoleId")
                        .HasDatabaseName("IDX_Users_RoleId");
            ...
            modelBuilder.Entity("MyWebApi.Models.DbProduct", b =>
                {
                    b.HasOne("MyWebApi.Models.DbCarrier", "CarrierEntity")
                        .WithMany("Products")
                        .HasForeignKey("CarrierID")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MyWebApi.Models.DbProductType", "ProductType")
                        .WithMany("Products")
                        .HasForeignKey("ProductTypeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("CarrierEntity");
            ...
            modelBuilder.Entity("MyWebApi.Models.DbRule", b =>
                {
                    ...
                    b.HasOne("MyWebApi.Models.DbProduct", "ProductEntity")
                        .WithMany("Rules")
            ...
            modelBuilder.Entity("MyWebApi.Models.DbUser", b =>
                {
                    b.HasOne("MyWebApi.Models.DbCarrier", "Carrier")
                        .WithMany("Users")
                        .HasForeignKey("CarrierID")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MyWebApi.Models.DbRole", "Role")
                        .WithMany("Users")
